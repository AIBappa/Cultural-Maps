"""
Django settings for freemarkt project.
...
SECRET_KEY = 'django-insecure-okj5#u=gc=g8jcf0)ek_(9j9n8unw)o_q=20%r7&vg(msu4!l)'
...
WSGI_APPLICATION = 'freemarkt.wsgi.application'
